...
class Report < ApplicationRecord
  ...
  has_many :mentioning, class_name: 'Relationship', foreign_key: 'mentioned_id', dependent: :destroy, inverse_of: :mentioned
  has_many :mentioned, class_name: 'Relationship', foreign_key: 'mentioning_id', dependent: :destroy, inverse_of: :mentioning
